 ...
 * @extends KitaBrowser
 */
export class MicrosoftEdgeBrowser extends KitaBrowser {
    /**
     ...
     * `reject` with Errors
     */
    static new(capabilities: KitaCapabilities): Promise<MicrosoftEdgeBrowser> {
     ...
     */
    navigate(url: string): Promise<MicrosoftEdgeBrowser> {
