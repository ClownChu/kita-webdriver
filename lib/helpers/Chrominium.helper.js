...
class ChrominiumHelper {
    ...
    static getLaunchOptions(capabilities) {
        ...
        const privateMode = capabilities.get(CapabilityDefinitions.SupportedCapabilities.PRIVATE_MODE)
        /** TODO : Validation helper */
    ...
    static navigate(instance, url) {
        /**
         * TODO : JavaScript navigation is not ideal
         */
        return new Promise((resolve, reject) => {
            instance.eval(`window.location = "${url}";`).then((response) => {
